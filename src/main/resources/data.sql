...
insert into message (issue_id, text, created_at, updated_at) values (1,'error message', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
insert into message (issue_id, text, created_at, updated_at) values (2,'simple message', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());